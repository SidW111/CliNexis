  ...
  return (
    ...
    <div className='max-w-6xl mx-auto p-2 '>
      <div className='flex flex-col sm:flex-row items-start gap-5 mt-5'>
        <div className={`py-1 px-3 border rounded text-sm transition-all duration-300 sm:hidden ${showFilter ? 'bg-blue-500 text-white' : ''}`} onClick={() => setShowFilter(prev => !prev)}>Filters</div>
